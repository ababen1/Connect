...
#
#const EMPTY_TILE = -1
#const DEFAULT_BOARD_SIZE = Vector2i(3,3)
...
#func _process(_delta: float) -> void:
	#queue_redraw()
	#debug_labels.set_label("mouse_cell", var_to_str(get_mouse_cell()))
#
...
#func get_cellv(cell_clicked: Vector2) -> int:
	#return get_cell_source_id(0, Vector2i(cell_clicked))
#
#func set_cellv(cell: Vector2, value: int) -> void:
	#set_cell(0, cell, value)
#
...
#
#func get_all_tiles_ids() -> Array[int]:
	#var tiles: Array[int] = []
	#for source_id in tile_set.get_source_count():
		#tiles.append(source_id)
	#return tiles
			#
#func get_random_tile() -> int:
	#var all_tiles = get_all_tiles_ids()
...
#
#func check_win() -> bool:
	#return get_used_cells(0).is_empty()
#
